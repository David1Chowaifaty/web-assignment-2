...
const IrCheckbox = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("input", { ref: el => (this.checkboxRef = el), type: "checkbox", disabled: this.disabled, onChange: this.handleChange.bind(this), checked: this.checked, class: this.checkboxStyle, id: this.inputId }), this.labelShown && (index.h("label", { class: this.labelStyle, htmlFor: this.inputId }, this.label))));
  }
  static get watchers() { return {
    "label": ["onLabelChange"]
  }; }
...
const IrLogin = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "app-content container center-layout mt-2" }, index.h("div", { class: "content-overlay" }), index.h("div", { class: "content-wrapper" }, index.h("div", { class: "content-body" }, index.h("section", { class: "row flexbox-container" }, index.h("div", { class: "col-12 d-flex align-items-center justify-content-center" }, index.h("div", { class: "col-lg-4 col-md-8 col-10 box-shadow-2 p-0" }, index.h("div", { class: "card border-grey border-lighten-3 m-0" }, index.h("ir-card-header", { class: "card-header border-0", "image-source": this.imagePath, "image-alt-text": "branding logo", "header-title": "Login with Modern" }), index.h("div", { class: "card-content" }, index.h("div", { class: "card-body" }, index.h("form", { ref: el => (this.formRef = el), class: "form-horizontal form-simple", novalidate: true, onSubmit: this.handleFormSubmit.bind(this) }, index.h("ir-input", { ref: el => (this.usernameRef = el), type: "text", icon: "la la-user", placeholder: "Your Username", required: true, "container-style": "mb-0" }), index.h("ir-input", { ref: el => (this.passwordRef = el), type: "password", icon: "la la-key", placeholder: "Enter Password", required: true }), index.h("div", { class: "form-group row" }, index.h("div", { class: "col-sm-6 col-12 text-center text-sm-left" }, index.h("ir-checkbox", { ref: el => (this.checkboxRef = el), label: "Remember Me", "input-id": "remember-me", "checkbox-style": "chk-remember" })), index.h("div", { class: "col-sm-6 col-12 text-center text-sm-right" }, index.h("ir-link", { "link-title": "Forgot Password?", "link-destination": "#" }))), index.h("ir-button", { class: "btn-block", type: "submit", icon: "ft-unlock", "button-style": "btn-block", "button-title": " Login", "color-variant": "info" })))), index.h("div", { class: "card-footer" }, index.h("div", { class: "" }, index.h("p", { class: "float-xl-left text-center m-0" }, index.h("ir-link", { "link-title": " Recover password", "link-destination": "#" })), index.h("p", { class: "float-xl-right text-center m-0" }, "New to Moden Admin? ", index.h("ir-link", { onClick: this.toggleSidebar.bind(this), "link-title": "Sign Up", "link-destination": "#" })))), index.h("ir-sidebar", { ref: el => (this.sidebarRef = el), open: this.isSidebarOpened }, index.h("ir-register", { "image-path": this.imagePath })))))))))));
  }
};
...
//# sourceMappingURL=ir-button_8.cjs.entry.js.map